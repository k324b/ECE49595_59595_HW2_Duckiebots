...
duckietown_msgs__msg__ObstacleType__create()
{
  ...
  duckietown_msgs__msg__ObstacleType * msg = (duckietown_msgs__msg__ObstacleType *)allocator.allocate(sizeof(duckietown_msgs__msg__ObstacleType), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(duckietown_msgs__msg__ObstacleType));
  bool success = duckietown_msgs__msg__ObstacleType__init(msg);
  if (!success) {
...
duckietown_msgs__msg__ObstacleType__destroy(duckietown_msgs__msg__ObstacleType * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    duckietown_msgs__msg__ObstacleType__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
duckietown_msgs__msg__ObstacleType__Sequence__init(duckietown_msgs__msg__ObstacleType__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  duckietown_msgs__msg__ObstacleType * data = NULL;

  if (size) {
    data = (duckietown_msgs__msg__ObstacleType *)allocator.zero_allocate(size, sizeof(duckietown_msgs__msg__ObstacleType), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = duckietown_msgs__msg__ObstacleType__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        duckietown_msgs__msg__ObstacleType__fini(&data[i - 1]);
      }
...
duckietown_msgs__msg__ObstacleType__Sequence__fini(duckietown_msgs__msg__ObstacleType__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      duckietown_msgs__msg__ObstacleType__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  duckietown_msgs__msg__ObstacleType__Sequence * array = (duckietown_msgs__msg__ObstacleType__Sequence *)allocator.allocate(sizeof(duckietown_msgs__msg__ObstacleType__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = duckietown_msgs__msg__ObstacleType__Sequence__init(array, size);
  if (!success) {
...
duckietown_msgs__msg__ObstacleType__Sequence__destroy(duckietown_msgs__msg__ObstacleType__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    duckietown_msgs__msg__ObstacleType__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
duckietown_msgs__msg__ObstacleType__Sequence__are_equal(const duckietown_msgs__msg__ObstacleType__Sequence * lhs, const duckietown_msgs__msg__ObstacleType__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!duckietown_msgs__msg__ObstacleType__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  duckietown_msgs__msg__ObstacleType__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(duckietown_msgs__msg__ObstacleType);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    duckietown_msgs__msg__ObstacleType * data =
      (duckietown_msgs__msg__ObstacleType *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!duckietown_msgs__msg__ObstacleType__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          duckietown_msgs__msg__ObstacleType__fini(&output->data[i]);
        }
        return false;
      }
    }
