...
#include "duckietown_msgs/srv/detail/get_variable__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/string__functions.h"  // name_json
...
using _GetVariable_Request__ros_msg_type = duckietown_msgs__srv__GetVariable_Request;
...
size_t get_serialized_size_duckietown_msgs__srv__GetVariable_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetVariable_Request__ros_msg_type * ros_message = static_cast<const _GetVariable_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GetVariable_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_duckietown_msgs__srv__GetVariable_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_duckietown_msgs
size_t max_serialized_size_duckietown_msgs__srv__GetVariable_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = duckietown_msgs__srv__GetVariable_Request;
    is_plain =
      (
      offsetof(DataType, name_json) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _GetVariable_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_duckietown_msgs__srv__GetVariable_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, duckietown_msgs, srv, GetVariable_Request)() {
...
// already included above
// #include "std_msgs/msg/detail/string__functions.h"  // value_json
...
using _GetVariable_Response__ros_msg_type = duckietown_msgs__srv__GetVariable_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_duckietown_msgs
size_t get_serialized_size_duckietown_msgs__srv__GetVariable_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetVariable_Response__ros_msg_type * ros_message = static_cast<const _GetVariable_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_duckietown_msgs__srv__GetVariable_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_duckietown_msgs
size_t max_serialized_size_duckietown_msgs__srv__GetVariable_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = duckietown_msgs__srv__GetVariable_Response;
    is_plain =
      (
...
static size_t _GetVariable_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_duckietown_msgs__srv__GetVariable_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, duckietown_msgs, srv, GetVariable_Response)() {
...
// already included above
// #include "duckietown_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "duckietown_msgs/srv/get_variable.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, duckietown_msgs, srv, GetVariable)() {
