...
#include "duckietown_msgs/msg/detail/twist2_d_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _Twist2DStamped__ros_msg_type = duckietown_msgs__msg__Twist2DStamped;
...
size_t get_serialized_size_duckietown_msgs__msg__Twist2DStamped(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Twist2DStamped__ros_msg_type * ros_message = static_cast<const _Twist2DStamped__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Twist2DStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_duckietown_msgs__msg__Twist2DStamped(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_duckietown_msgs
size_t max_serialized_size_duckietown_msgs__msg__Twist2DStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = duckietown_msgs__msg__Twist2DStamped;
    is_plain =
      (
...
static size_t _Twist2DStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_duckietown_msgs__msg__Twist2DStamped(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, duckietown_msgs, msg, Twist2DStamped)() {
