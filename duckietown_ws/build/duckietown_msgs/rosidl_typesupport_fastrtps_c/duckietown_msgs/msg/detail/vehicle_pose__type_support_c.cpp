...
#include "duckietown_msgs/msg/detail/vehicle_pose__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/bool__functions.h"  // detection
#include "std_msgs/msg/detail/float32__functions.h"  // psi, rho, theta
...
using _VehiclePose__ros_msg_type = duckietown_msgs__msg__VehiclePose;
...
size_t get_serialized_size_duckietown_msgs__msg__VehiclePose(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VehiclePose__ros_msg_type * ros_message = static_cast<const _VehiclePose__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_std_msgs__msg__Float32(
    &(ros_message->rho), current_alignment);
  // field.name theta

  current_alignment += get_serialized_size_std_msgs__msg__Float32(
    &(ros_message->theta), current_alignment);
  // field.name psi

  current_alignment += get_serialized_size_std_msgs__msg__Float32(
    &(ros_message->psi), current_alignment);
  // field.name detection
...
static uint32_t _VehiclePose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_duckietown_msgs__msg__VehiclePose(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_duckietown_msgs
size_t max_serialized_size_duckietown_msgs__msg__VehiclePose(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = duckietown_msgs__msg__VehiclePose;
    is_plain =
      (
...
static size_t _VehiclePose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_duckietown_msgs__msg__VehiclePose(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, duckietown_msgs, msg, VehiclePose)() {
