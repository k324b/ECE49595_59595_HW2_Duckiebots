...
#include "duckietown_msgs/msg/detail/april_tag_detection__rosidl_typesupport_fastrtps_c.h"
...
using _AprilTagDetection__ros_msg_type = duckietown_msgs__msg__AprilTagDetection;
...
static uint32_t _AprilTagDetection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_duckietown_msgs__msg__AprilTagDetection(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = duckietown_msgs__msg__AprilTagDetection;
    is_plain =
      (
...
static size_t _AprilTagDetection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_duckietown_msgs__msg__AprilTagDetection(
