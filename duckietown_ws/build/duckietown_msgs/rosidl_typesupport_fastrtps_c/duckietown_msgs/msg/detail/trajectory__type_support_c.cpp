...
#include "duckietown_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3_stamped__functions.h"  // acc, jerk, pos, vel
...
using _Trajectory__ros_msg_type = duckietown_msgs__msg__Trajectory;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: pos
  {
    ...
    if (ros_message->pos.data) {
      geometry_msgs__msg__Vector3Stamped__Sequence__fini(&ros_message->pos);
    }
    if (!geometry_msgs__msg__Vector3Stamped__Sequence__init(&ros_message->pos, size)) {
  ...
  // Field name: vel
  {
    ...
    if (ros_message->vel.data) {
      geometry_msgs__msg__Vector3Stamped__Sequence__fini(&ros_message->vel);
    }
    if (!geometry_msgs__msg__Vector3Stamped__Sequence__init(&ros_message->vel, size)) {
  ...
  // Field name: acc
  {
    ...
    if (ros_message->acc.data) {
      geometry_msgs__msg__Vector3Stamped__Sequence__fini(&ros_message->acc);
    }
    if (!geometry_msgs__msg__Vector3Stamped__Sequence__init(&ros_message->acc, size)) {
  ...
  // Field name: jerk
  {
    ...
    if (ros_message->jerk.data) {
      geometry_msgs__msg__Vector3Stamped__Sequence__fini(&ros_message->jerk);
    }
    if (!geometry_msgs__msg__Vector3Stamped__Sequence__init(&ros_message->jerk, size)) {
...
size_t get_serialized_size_duckietown_msgs__msg__Trajectory(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Trajectory__ros_msg_type * ros_message = static_cast<const _Trajectory__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Trajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_duckietown_msgs__msg__Trajectory(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_duckietown_msgs
size_t max_serialized_size_duckietown_msgs__msg__Trajectory(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = duckietown_msgs__msg__Trajectory;
    is_plain =
      (
...
static size_t _Trajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_duckietown_msgs__msg__Trajectory(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, duckietown_msgs, msg, Trajectory)() {
