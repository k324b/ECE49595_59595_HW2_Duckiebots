...
#include "duckietown_msgs/msg/detail/vector2_d__rosidl_typesupport_fastrtps_c.h"
...
using _Vector2D__ros_msg_type = duckietown_msgs__msg__Vector2D;
...
static uint32_t _Vector2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_duckietown_msgs__msg__Vector2D(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = duckietown_msgs__msg__Vector2D;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
static size_t _Vector2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_duckietown_msgs__msg__Vector2D(
